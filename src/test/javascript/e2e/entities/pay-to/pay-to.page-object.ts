...
export class PayToComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-pay-to div table .ui-button-danger'));
  title = element.all(by.css('jhi-pay-to div h2#page-heading span')).first();
...
export class PayToUpdatePage {
  pageTitle = element(by.id('jhi-pay-to-heading'));
...
export class PayToDeleteDialog {
