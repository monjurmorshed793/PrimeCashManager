...
/**
 * Criteria class for the {@link org.cash.manager.domain.ExpenseDtl} entity. This class is used
 * in {@link org.cash.manager.web.rest.ExpenseDtlResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /expense-dtls?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ExpenseDtlCriteria implements Serializable, Criteria {
    ...
    public ExpenseDtlCriteria() {
    }

    public ExpenseDtlCriteria(ExpenseDtlCriteria other) {
    ...
    @Override
    public ExpenseDtlCriteria copy() {
        return new ExpenseDtlCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ExpenseDtlCriteria that = (ExpenseDtlCriteria) o;
        return
